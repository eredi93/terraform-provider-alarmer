...
func resourceAlarmerDatadogMonitor() *schema.Resource {
	return &schema.Resource{
		Create: resourceAlarmerDatadogMonitorCreate,
		Read:   resourceAlarmerDatadogMonitorRead,
		Update: resourceAlarmerDatadogMonitorUpdate,
		Delete: resourceAlarmerDatadogMonitorDelete,
		Exists: resourceAlarmerDatadogMonitorExists,
...
func resourceAlarmerDatadogMonitorExists(d *schema.ResourceData, meta interface{}) (b bool, e error) {
...
func resourceAlarmerDatadogMonitorCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceAlarmerDatadogMonitorRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*datadog.Client)
...
func resourceAlarmerDatadogMonitorUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*datadog.Client)
...
func resourceAlarmerDatadogMonitorDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*datadog.Client)
...
func resourceAlarmerDatadogImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
